...
- Name: Dashboard Loading States and Error Handling >> should handle browser navigation correctly
- Location: C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\dashboard-loading-states.spec.ts:134:7
...
Call log:
  ...
  - waiting for locator('h1, h2').filter({ hasText: /sign in|login/i })
    ...
    at C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\dashboard-loading-states.spec.ts:141:80
```
