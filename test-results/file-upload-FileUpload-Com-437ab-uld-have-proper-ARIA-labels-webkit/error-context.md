...
- Name: FileUpload Component E2E Tests >> Accessibility >> should have proper ARIA labels
- Location: C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\file-upload.spec.ts:324:9
...
Call log:
  - waiting for locator('[data-testid="airline-selector"]')
    ...
    at C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\file-upload.spec.ts:326:18
```
