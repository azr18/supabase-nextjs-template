...
- Name: Subscription Status Indicators and User Feedback >> Interactive Features >> should show subscription information on hover tooltips
- Location: C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\subscription-status-indicators.spec.ts:143:9
...
Call log:
  - waiting for locator('[data-testid="dashboard-content"]') to be visible
    ...
    at C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\subscription-status-indicators.spec.ts:144:18
```
