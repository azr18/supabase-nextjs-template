...
- Name: Subscription Status Indicators and User Feedback >> Visual Status Indicators >> should display subscription countdown timers for trial/expiring subscriptions
- Location: C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\subscription-status-indicators.spec.ts:53:9
...
Call log:
  - waiting for locator('[data-testid="dashboard-content"]') to be visible
    ...
    at C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\subscription-status-indicators.spec.ts:54:18
```
