...
- Name: Dashboard Loading States and Error Handling >> should show register page elements
- Location: C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\dashboard-loading-states.spec.ts:24:7

# Error details

```
Error: expect.toBeVisible: Error: strict mode violation: locator('input[type="password"]') resolved to 2 elements:
    1) <input value="" required="" id="password" type="password" name="password" autocomplete="new-password" class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-primary-500 focus:outline-none focus:ring-primary-500"/> aka getByRole('textbox', { name: 'Password', exact: true })
    2) <input value="" required="" type="password" id="confirmPassword" name="confirmPassword" autocomplete="new-password" class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-primary-500 focus:outline-none focus:ring-primary-500"/> aka getByRole('textbox', { name: 'Confirm Password' })

Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('input[type="password"]')

    at C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\dashboard-loading-states.spec.ts:29:58
```
