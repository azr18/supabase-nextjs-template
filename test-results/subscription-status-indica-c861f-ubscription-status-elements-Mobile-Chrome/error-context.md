...
- Name: Subscription Status Indicators and User Feedback >> Accessibility Features >> should have proper ARIA labels for subscription status elements
- Location: C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\subscription-status-indicators.spec.ts:264:9
...
Call log:
  - waiting for locator('[data-testid="dashboard-content"]') to be visible
    ...
    at C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\subscription-status-indicators.spec.ts:265:18
```
