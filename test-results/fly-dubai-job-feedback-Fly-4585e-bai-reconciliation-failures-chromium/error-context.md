...
- Name: Fly Dubai Job Submission UI Feedback (Task 8.2) >> should display enhanced error feedback for Fly Dubai reconciliation failures
- Location: C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\fly-dubai-job-feedback.spec.ts:114:7
...
Call log:
  ...
  - waiting for locator('h1')
    - locator resolved to <h1 class="text-4xl font-bold bg-gradient-to-r from-gray-800 via-blue-600 to-violet-600 bg-clip-text text-transparent mb-4 leading-normal">My Agent</h1>
