...
Call log:
  - navigating to "http://localhost:3000/app/invoice-reconciler", waiting until "load"

    at C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\fly-dubai-job-feedback.spec.ts:6:16
```
