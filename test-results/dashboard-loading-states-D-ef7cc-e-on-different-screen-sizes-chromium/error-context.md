...
- Name: Dashboard Loading States and Error Handling >> should be responsive on different screen sizes
- Location: C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\dashboard-loading-states.spec.ts:33:7
...
Call log:
  ...
  - waiting for locator('input[type="email"]')
    ...
    at C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\dashboard-loading-states.spec.ts:38:55
```
