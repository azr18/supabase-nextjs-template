...
- Name: Subscription Status Indicators and User Feedback >> Visual Status Indicators >> should show different badge variants for different subscription states
- Location: C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\subscription-status-indicators.spec.ts:34:9
...
Call log:
  - waiting for locator('[data-testid="dashboard-content"]') to be visible
    ...
    at C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\subscription-status-indicators.spec.ts:35:18
```
