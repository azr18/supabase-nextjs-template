...
- Name: Subscription Status Indicators and User Feedback >> Loading States and Error Handling >> should show appropriate loading states while checking subscription status
- Location: C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\subscription-status-indicators.spec.ts:193:9
...
Locator: locator('[data-testid="dashboard-content"]')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 15000ms
  - waiting for locator('[data-testid="dashboard-content"]')

    at C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\subscription-status-indicators.spec.ts:209:71
```
