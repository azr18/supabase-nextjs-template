...
- Name: Subscription Status Indicators and User Feedback >> User Feedback Messages >> should show appropriate feedback when clicking on tools with different subscription states
- Location: C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\subscription-status-indicators.spec.ts:70:9
...
Call log:
  - waiting for locator('[data-testid="dashboard-content"]') to be visible
    ...
    at C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\subscription-status-indicators.spec.ts:71:18
```
