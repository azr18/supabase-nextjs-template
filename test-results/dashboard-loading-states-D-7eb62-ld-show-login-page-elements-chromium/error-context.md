...
- Name: Dashboard Loading States and Error Handling >> should show login page elements
- Location: C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\dashboard-loading-states.spec.ts:15:7
...
Call log:
  ...
  - waiting for locator('input[type="email"]')
    ...
    at C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\dashboard-loading-states.spec.ts:19:55
```
