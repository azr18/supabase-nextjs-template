...
- Name: FileUpload Component E2E Tests >> Visual States >> should show loading state during file validation
- Location: C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\file-upload.spec.ts:336:9
...
Call log:
  - waiting for locator('[data-testid="airline-selector"]')
    ...
    at C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\file-upload.spec.ts:338:18
```
