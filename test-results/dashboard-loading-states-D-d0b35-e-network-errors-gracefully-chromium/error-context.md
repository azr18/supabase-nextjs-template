...
- Name: Dashboard Loading States and Error Handling >> should handle network errors gracefully
- Location: C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\dashboard-loading-states.spec.ts:49:7
...
Call log:
  - waiting for locator('input[type="email"]')
    ...
    at C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\dashboard-loading-states.spec.ts:55:47
```
