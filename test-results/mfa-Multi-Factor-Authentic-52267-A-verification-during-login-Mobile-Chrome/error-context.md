...
- Name: Multi-Factor Authentication (MFA) >> MFA Authentication Flow >> completes MFA verification during login
- Location: C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\mfa.spec.ts:479:9
...
Call log:
  - waiting for locator('input[placeholder*="Enter 6-digit code"]')

    at C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\mfa.spec.ts:519:18
```
