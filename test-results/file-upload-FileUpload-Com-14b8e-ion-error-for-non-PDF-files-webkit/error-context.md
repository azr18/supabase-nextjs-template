...
- Name: FileUpload Component E2E Tests >> File Upload Functionality >> should show validation error for non-PDF files
- Location: C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\file-upload.spec.ts:179:9
...
Call log:
  - waiting for locator('[data-testid="airline-selector"]')
    ...
    at C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\file-upload.spec.ts:181:18
```
