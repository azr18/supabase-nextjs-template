...
- Name: Multi-Factor Authentication (MFA) >> MFA Authentication Flow >> displays MFA verification page correctly
- Location: C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\mfa.spec.ts:453:9
...
Locator: locator('text=Two-Factor Authentication Required')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('text=Two-Factor Authentication Required')

    at C:\Users\ariel\Documents\GitHub\supabase-nextjs-template\tests\e2e\mfa.spec.ts:474:77
```
